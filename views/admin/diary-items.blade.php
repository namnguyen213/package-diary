...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-info">
                    ...
                    <div class='panel-info panel-description'>
                        ...
                        @if($is_admin)
                        <p>You are admin, <a href="{!! Url::route('diaries.list',['user_id' => $user_id]) !!}">click here</a> to view your created rules
                        @endif
                    </div>
                    <!--/DESCRIPTION-->
                    ...
                    <div class="panel-body">
                        {!! Form::open(['route'=>['diaries.delete', 'id' => @$item->id], 'method' => 'get'])  !!}

                            @include('package-diary::admin.diary-item')
            ...
            <!--SEARCH-->
            <div class="col-md-3">
                @include('package-diary::admin.diary-search')
            </div>
            <!--/SEARCH-->
